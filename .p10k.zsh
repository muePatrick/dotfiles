# Generated by Powerlevel10k configuration wizard on 2022-10-18 at 09:58 CEST.
...
function prompt_github_login() {
  local text
  if [[ "${GITHUB_LOGGED_IN}" == "true" ]]; then
    text=' '
  else
    text=' '
  fi
  p10k segment -b '#6E40C9' -f '#FFFFFF' -i '' -t "${text}"
}

function prompt_space_icon() {
  p10k segment -f '#FFFFFF' -t " "
}
